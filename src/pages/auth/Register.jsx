          ...
          {step === 1 ? (
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div>
                ...
                <select
                  className="w-full bg-white border border-gray-200 rounded-full text-slate-800 px-6 py-3.5 focus:outline-none focus:border-accent focus:ring-1 focus:ring-accent transition-colors appearance-none cursor-pointer"
                  value={form.role}
              ...
              <div className="pt-2 flex flex-col sm:flex-row gap-4">
                ...
                type="submit"
                disabled={loading}
                className="w-full bg-accent text-black font-black py-5 rounded-2xl hover:scale-[1.02] active:scale-[0.98] transition-all shadow-xl shadow-accent/20 disabled:opacity-50 disabled:hover:scale-100 uppercase tracking-widest text-xs"
              >
                  {loading ? (
                ...
                <Link
                  to="/login"
                  className="flex-1 bg-black hover:bg-gray-900 text-accent font-bold py-3.5 px-6 rounded-full transition-all flex items-center justify-center text-sm shadow-sm active:scale-95"
                >
                  Back to Sign In
                </Link>
              </div>
