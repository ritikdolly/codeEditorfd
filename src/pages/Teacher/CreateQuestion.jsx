    ...
    <div className="p-8 max-w-5xl mx-auto space-y-10 animate-in fade-in slide-in-from-bottom-4 duration-700 pb-20">
      <header className="flex flex-col md:flex-row md:items-center justify-between gap-6">
        <div>
          ...
          <h1 className="text-4xl font-black text-white tracking-tight leading-tight">Create Problem</h1>
          <p className="text-slate-400 mt-2 text-lg font-medium">Draft a high-impact coding challenge for your students.</p>
        </div>
      </header>
      ...
      <form onSubmit={handleSubmit} className="space-y-10">
        ...
        <div className="glass-card p-8 border border-slate-700/50 shadow-2xl relative overflow-hidden group bg-slate-900/40">
           ...
           <div className="flex items-center gap-3 mb-8 relative z-10">
              ...
              <h2 className="text-2xl font-black text-white tracking-tight">Challenge Definitions</h2>
           </div>
           ...
           <div className="space-y-8 relative z-10">
              ...
              <div className="space-y-3">
                ...
                <textarea className="field-input min-h-[180px] py-4 px-6 bg-slate-950/50 border-slate-700 focus:border-purple-500 leading-relaxed Custom-scrollbar" required value={form.description}
                  ...
                  placeholder="Articulate the problem and its nuances..." />
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div className="space-y-2">
                  ...
                  <div className="relative group/select">
                    <select className="field-input py-3 px-4 bg-slate-950/50 border-slate-700 focus:border-purple-500 appearance-none cursor-pointer" value={form.difficulty}
                      ...
                      <option value="EASY">Level: Junior</option>
                      <option value="MEDIUM">Level: Mid-Core</option>
                      <option value="HARD">Level: Master</option>
                    </select>
                ...
                <div className="space-y-2">
                  <label className="text-[11px] font-black text-slate-500 uppercase tracking-widest">Scoring Pts</label>
                ...
                <div className="space-y-2">
                  <label className="text-[11px] font-black text-slate-500 uppercase tracking-widest">Time Budget</label>
        ...
        <div className="glass-card p-8 border border-slate-700/50 shadow-2xl relative bg-slate-900/40">
           <div className="flex items-center gap-3 mb-8">
              ...
              <h2 className="text-2xl font-black text-white tracking-tight">Instruction Set</h2>
           </div>

           <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
              <div className="space-y-3">
                <label className="text-[11px] font-black text-slate-500 uppercase tracking-widest">Input Architecture</label>
                <textarea className="field-input min-h-[100px] py-3 px-4 bg-slate-950/50 border-slate-700 focus:border-purple-500 text-sm italic" placeholder="How data flows in..."
                  value={form.inputFormat} onChange={e => setForm({ ...form, inputFormat: e.target.value })} />
              </div>
              <div className="space-y-3">
                <label className="text-[11px] font-black text-slate-500 uppercase tracking-widest">Output Architecture</label>
                <textarea className="field-input min-h-[100px] py-3 px-4 bg-slate-950/50 border-slate-700 focus:border-purple-500 text-sm italic" placeholder="Expected result topology..."
                  value={form.outputFormat} onChange={e => setForm({ ...form, outputFormat: e.target.value })} />
              </div>
           </div>

           <div className="space-y-3">
              <label className="text-[11px] font-black text-slate-500 uppercase tracking-widest">Operational Constraints</label>
        ...
        <div className="glass-card p-8 border border-slate-700/50 shadow-2xl relative bg-slate-950/40 overflow-hidden group">
           ...
           <div className="flex items-center gap-3 mb-4 relative z-10">
              ...
              <h2 className="text-2xl font-black text-white tracking-tight">Logic Scaffolding</h2>
           </div>
           <p className="text-sm text-slate-500 mb-8 font-medium">Wrap the challenge with pre-built logic for streamlined execution.</p>

           <div className="space-y-8 relative z-10">
              <div className="space-y-3">
                <div className="flex items-center justify-between">
                  <label className="text-[11px] font-black text-slate-500 uppercase tracking-widest">Live Editor Initial State</label>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 pt-4 border-t border-slate-800/50">
                <div className="space-y-3">
                  <label className="text-[11px] font-black text-slate-500 uppercase tracking-widest flex items-center gap-2 text-rose-400/70">
                     <Settings size={12} /> Prefix Runtime (Hidden)
                  </label>
                ...
                <div className="space-y-3">
                  <label className="text-[11px] font-black text-slate-500 uppercase tracking-widest flex items-center gap-2 text-amber-400/70">
                     <Settings size={12} /> Suffix Runtime (Hidden)
                  </label>
        ...
        <div className="glass-card p-8 border border-slate-700/50 shadow-2xl relative bg-slate-900/40">
           <div className="flex items-center justify-between mb-8">
              <div className="flex items-center gap-3">
                ...
                <h2 className="text-2xl font-black text-white tracking-tight">Validation Matrix</h2>
              </div>
                ...
                <div key={i} className="bg-slate-950/40 rounded-3xl p-6 space-y-6 border border-slate-800/80 hover:border-amber-500/20 transition-all group/case">
                  <div className="flex items-center justify-between border-b border-slate-800/50 pb-4">
                    <div className="flex items-center gap-3">
                      ...
                      <span className="text-white font-black text-xs uppercase tracking-widest opacity-60 group-hover/case:opacity-100 transition-opacity">Scenario Prototype</span>
                    </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="space-y-2">
                       <label className="text-[9px] font-black text-slate-600 uppercase tracking-tighter">Telemetric Input</label>
                    ...
                    <div className="space-y-2">
                       <label className="text-[9px] font-black text-slate-600 uppercase tracking-tighter">Target Result</label>
        ...
        <div className="fixed bottom-0 left-0 right-0 p-4 bg-slate-950/80 backdrop-blur-3xl border-t border-slate-800/50 z-50 animate-in slide-in-from-bottom-full duration-1000">
           <div className="max-w-5xl mx-auto flex items-center justify-between gap-6">
              ...
              <div className="flex items-center gap-4 w-full md:w-auto">
                <button type="button" onClick={() => navigate('/teacher')} className="btn-secondary px-8 py-3 rounded-2xl text-xs font-black uppercase tracking-widest whitespace-nowrap">
                  Discard Assets
                </button>
                <button type="submit" disabled={loading} className="btn-primary flex-1 md:flex-none px-10 py-3.5 rounded-2xl text-xs font-black uppercase tracking-widest flex items-center justify-center gap-3 shadow-2xl hover:scale-[1.03] transition-all disabled:opacity-50">
                  ...
                  {loading ? 'Synthesizing...' : 'Commit Problem to Bank'}
                </button>
              </div>
           </div>
        </div>
