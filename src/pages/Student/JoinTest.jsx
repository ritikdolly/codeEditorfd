...
export default function JoinTest() {
  ...
  return (
    <div className="min-h-screen bg-[#09090b] relative overflow-hidden selection:bg-accent selection:text-black">
      {/* Decorative Glow */}
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-accent/5 rounded-full blur-[140px] pointer-events-none"></div>
      ...
      <div className="flex flex-col items-center justify-center pt-32 px-4 relative z-10">
        {loading ? (
          <div className="flex flex-col items-center gap-4">
             <div className="w-12 h-12 rounded-2xl border-2 border-accent/20 border-t-accent animate-spin"></div>
          ...
          <div className="bg-[#111111] p-12 max-w-xl w-full shadow-2xl rounded-[48px] text-center border border-white/10 relative overflow-hidden group">
            ...
            <div className="relative z-10 flex flex-col items-center">
               <div className="w-16 h-16 rounded-2xl bg-accent/10 flex items-center justify-center text-accent mb-8 border border-accent/20 shadow-xl">
               ...
               <p className="text-accent text-[10px] font-bold uppercase tracking-[0.4em] mb-12 flex items-center gap-3">
               ...
               <div className="bg-black/40 rounded-[32px] p-8 mb-12 text-left border border-white/5 w-full space-y-8 shadow-inner">
                 <div className="flex items-center justify-between">
                    ...
                    <div>
                       <span className={`inline-flex px-4 py-1.5 rounded-xl text-[10px] font-bold uppercase tracking-widest border ${testDetails.status === "ACTIVE" ? "bg-accent/10 text-accent border-accent/30" : "bg-white/5 text-amber-500 border-white/10"}`}>
                         {testDetails.status}
                       </span>
                    </div>
                 </div>
               ...
               <button
                 ...
                 className="w-full py-5 px-8 bg-accent hover:bg-accent-dark text-black rounded-2xl font-bold text-sm shadow-xl shadow-accent/10 transition-all uppercase tracking-widest active:scale-95 disabled:bg-white/5 disabled:text-gray-600 disabled:border-white/5 disabled:cursor-not-allowed flex items-center justify-center gap-3"
               >
